...
from models.torch_util import load_state_dict_from_url
import torch
...
def resnet18im(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet('resnet18im', BasicBlock, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)


def resnet34im(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet34im', BasicBlock, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)


def resnet50im(pretrained=False, progress=True, **kwargs):
